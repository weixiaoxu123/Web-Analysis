...
def feature_Url():
    ...
    url_zimu_num=[]
    url_T_zifu_num=[]
    positive = pd.read_csv('nage_url_code.csv')
...
#            scriptObjectinnerHTML_num=str(data).count('scriptObject.innerHTML')
        ...
        print(data)  
        datass.to_csv('nage_code4.csv',header=0,index=0)
...
#    positive.insert(19,'windowopen_num',code_windowopen_num)
    ...
    positive.to_csv('nage_code_features.csv',index=False)
    return positive

if __name__=='__main__':
    #  add url fearture
#    positive = pd.read_excel('nage.xlsx')
#    positive = pd.read_csv('nage_url.csv',encoding='gb18030')
